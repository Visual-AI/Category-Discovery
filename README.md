...
| Year   | Method                                                                 | Pub.      | Backbone               | Scenario                | Label Assignment         | # Unlabelled categories | Dataset                                      | $ \mathcal{Y_L} \cap \mathcal{Y_U} $ |
|--------|------------------------------------------------------------------------|-----------|------------------------|-------------------------|--------------------------|-------------------------|----------------------------------------------|------------------------------------------|
| 2022   | [NCDwF](https://arxiv.org/abs/2207.10659)                  | *ECCV*   | ResNet              | Class Incremental       | Parametric Classifier     | Known                   | CIFAR-10/100, ImageNet-1K                   | $ \varnothing $                       |
|        | [FRoST](https://arxiv.org/abs/2207.08605)                                              | *ECCV*   | ResNet              | Class Incremental       | Parametric Classifier     | Known                   | CIFAR-10/100, TinyImageNet                 | $ \varnothing $                       |
...
| 2024   | [Msc-iNCD](https://arxiv.org/abs/2303.15975)                                          | *ICPR*   | ViT               | Class Incremental       | Parametric Classifier     | Known                   | CIFAR-100, ImageNet-100/1K                 | $ \varnothing $                       |
|        | [ADM](https://arxiv.org/abs/2403.03382)               | *AAAI*   | ResNet              | Class Incremental       | Parametric Classifier     | Known                   | CIFAR-10/100, TinyImageNet                 | $ \varnothing $                       |
...
| Preprint| [FEA](https://arxiv.org/abs/2405.06389)                         | *ArXiv*  | ViT               | Class Incremental       | Parametric Classifier     | Known                   | CIFAR-10/100, TinyImageNet                 | $ \varnothing $                       |
...
| Year   | Method                                                                 | Pub.     | Backbone        | Scenario                              | Label Assignment     | # Unlabelled categories | Dataset                                                | $ \mathcal{Y_L} \cap \mathcal{Y_U} $ |
|--------|------------------------------------------------------------------------|----------|-----------------|---------------------------------------|----------------------|-------------------------|--------------------------------------------------------|------------------------------------------|
| 2023   | [NCDLR](https://openreview.net/forum?id=ey5b7kODvK)                                             | *TMLR*  | ViT        | Long-tailed Distribution for $ \mathcal{Y_L} \& \mathcal{Y_U} $ | Parametric Classifier | $k$-Means               | CIFAR-10, ImageNet-100, Herb19, iNaturalist18          | $ \varnothing $                       |
...
|        | [BYOP](https://openaccess.thecvf.com/content/CVPR2023/html/Yang_Bootstrap_Your_Own_Prior_Towards_Distribution-Agnostic_Novel_Class_Discovery_CVPR_2023_paper.html)                                          | *CVPR*  | ResNet       | Imbalanced Distribution for $ \mathcal{Y_U} $ | Parametric Classifier | Known                   | CIFAR-10\&100, TinyImageNet                             | $ \varnothing $                       |
